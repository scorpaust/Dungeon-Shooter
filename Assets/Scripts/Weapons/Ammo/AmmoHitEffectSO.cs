...
public class AmmoHitEffectSO : ScriptableObject
{
	...
	#region Tooltip
	[Tooltip("The color gradient for the hit effect. This gradient shows the color of particles during their lifetime - from left to right")]
	#endregion Tooltip
	...
	#region Tooltip
	[Tooltip("How much particles should be emitted in the particle effect burst")]
	#endregion Tooltip
	...
	#region Tooltip
	[Tooltip("The sprite for the particle effect. If none is then specified the default particle sprite")]
	#endregion Tooltip
	...
	#region Tooltip
	[Tooltip("ammoHitEffectPrefab~contains the particle system for the hit effect and is configured by the AmmoHitEffectSO")]
	#endregion Tooltip
