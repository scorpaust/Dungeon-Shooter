...
public class WeaponDetailsSO : ScriptableObject
{
	...
	#region Tooltip
	[Tooltip("Weapon shoot effect SO - contains particle effect parameters to be used in conjunction with the weapon shoot effect prefab")]
	#endregion Tooltip
	...
	#region Tooltip
	[Tooltip("Weapon fire rate - 0.2f means 5 shots a second")]
	#endregion Tooltip
