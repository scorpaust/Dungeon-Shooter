...
public class AStarTest : MonoBehaviour
{
	...
	private void Start()
	{
        startPathTile = GameResources.Instance.preferedEnemyPathTile;
    ...
    private void StaticEventHandler_OnRoomChanged(RoomChangedEventArgs roomChangedEventArgs)
	{
        ...
        instantiatedRoom = roomChangedEventArgs.room.instanciatedRoom;
	...
	private void Update()
	{
        if (instantiatedRoom == null || startPathTile == null || grid == null || pathTilemap == null) return;
